...
export function SearchPage() {
  ...
  return (
    <div>
      ...
      {query.isError && (
        <div className="mt-4 flex flex-col gap-3 rounded-2xl border border-danger/20 bg-danger/5 p-4 text-sm text-danger sm:flex-row sm:items-center sm:justify-between">
